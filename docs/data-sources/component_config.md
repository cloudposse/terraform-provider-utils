...
- `process_templates` (Boolean) Set to true to enable Go template processing in the component config output.
- `process_yaml_functions` (Boolean) Set to true to enable YAML function processing (e.g., !terraform.output) in the component config output.
