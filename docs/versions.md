...
> **Note:** Where multiple provider releases share an Atmos version, only the latest (recommended) release is shown.
> Patch releases (e.g. `v2.0.2`, `v1.4.1`) that differ only in bug-fixes or CI changes are omitted; always prefer
> the latest provider release for a given Atmos version.

| Atmos Version | Recommended `cloudposse/utils` Version |
|---|---|
| [v1.211.0](https://github.com/cloudposse/atmos/releases/tag/v1.211.0) | [v2.5.0](https://github.com/cloudposse/terraform-provider-utils/releases/tag/v2.5.0) |
| [v1.210.1](https://github.com/cloudposse/atmos/releases/tag/v1.210.1) | [v2.4.0](https://github.com/cloudposse/terraform-provider-utils/releases/tag/v2.4.0) |
| [v1.209.0](https://github.com/cloudposse/atmos/releases/tag/v1.209.0) | [v2.1.0](https://github.com/cloudposse/terraform-provider-utils/releases/tag/v2.1.0) |
