...
func TestComponentProcessor(t *testing.T) {
	...
	assert.Equal(t, "orgs/cp/tenant1/dev/us-east-2", tenant1Ue2DevTestTestComponentOverrideComponentDeps[11])
	...
	assert.Equal(t, 16, len(tenant1Ue2DevTestTestComponentOverrideComponent3Deps))
